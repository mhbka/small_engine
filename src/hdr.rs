use crate::graphics::gpu::{GpuContext, bind_group::GpuBindGroup, pipeline::GpuPipeline, texture::GpuTexture};
...
impl HdrPipeline {
    ...
    pub fn new(gpu: &GpuContext, config: &wgpu::SurfaceConfiguration) -> Self {
        ...
        let texture = GpuTexture::create_2d_texture(
            gpu, 
            width, 
            height, 
            Self::COLOR_FORMAT, 
    ...
    pub fn resize(&mut self, gpu: &GpuContext, width: u32, height: u32) {
        self.texture = GpuTexture::create_2d_texture(
            gpu, 
            width, 
            height, 
            Self::COLOR_FORMAT,
