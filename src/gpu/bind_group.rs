...
impl GpuBindGroup {
    ...
    pub fn create_with_desc(gpu: &GpuContext, layout_desc: &wgpu::BindGroupLayoutDescriptor, desc: &wgpu::BindGroupDescriptor) -> Self {
        let device = gpu.device();
    ...
    pub fn handle(&self) -> &wgpu::BindGroup { &self.group }
